...
export default function Header() {
  return (
    <header className={styles.header}>
      {/* Logo */}
      <img src="/imagens/logo.png" alt="logo" className={styles.logo} />
          ...
          <div className="relative">
            <input
              ...
              className="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm 
                         border border-slate-200 rounded-md pl-3 pr-28 py-2 transition duration-300 
                         ease focus:outline-none focus:border-slate-400 hover:border-slate-300 
            ...
            <button
              ...
              className="absolute top-1 right-1 flex items-center rounded bg-slate-800 py-1 px-2.5 
                         ...
                         active:bg-slate-700 hover:bg-slate-700 active:shadow-none 
